...
class FabricaPanelBoton {
    ...
    private static JPanel obtenerPanelBase(int x, int y, int wP, int hP,
    ...
    static JPanel obtenerBotonConIcono(int x, int y, int wP, int hP, int aG,
            Image imagenIcono, Color color, String nombre) {
        int dimI;
        dimI = wP - aG;
        JPanel panelBoton = obtenerPanelBase(x, y, wP, hP, color, nombre);
        ImageIcon icono = new ImageIcon(
                imagenIcono.getScaledInstance(dimI, dimI, Image.SCALE_SMOOTH));
    ...
    static JPanel obtenerBotonConIconoTexto(int x, int y, int wP, int hP,
            int aG, Image imagenIcono, String texto, Color color,
            String nombre) {
        JPanel panelBoton = obtenerBotonConIcono(x, y, wP, hP, aG, imagenIcono,
                color, nombre);
        JLabel etiquetaTexto = new JLabel(texto);
        etiquetaTexto.setFont(etiquetaTexto.getFont()
                .deriveFont(etiquetaTexto.getFont().getStyle() | Font.BOLD));
